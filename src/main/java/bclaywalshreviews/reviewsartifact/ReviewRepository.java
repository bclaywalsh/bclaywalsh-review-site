...
public class ReviewRepository {
    ...
    public ReviewRepository() {
        ...
        Review hyperLightDrifter = new Review(4L, "Hyper Light Drifter", "Indie Game", "/images/hyperlightdrifter2.png", "Heart Machine, Abylight S.L.", "A predominant theme in Hyper Light Drifter is chronic illness and something being subtly, terribly wrong in the world. The jarringly bright colors and high-contrast environments hide many things in their shadows, and throughout the game you are rewarded for thinking outside the box. The game has hands-down the most intriguing and jaw-dropping opening I've ever seen, and while the game is quite enjoyable I wish that sense of awe continued, but sadly the game ends on a somewhat bland note. The action is good old-fashioned top-down sword and gunplay, and the music is just okay. 7/10");
